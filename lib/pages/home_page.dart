...
import 'package:gonzalez0488/data/categories.dart';
import 'package:gonzalez0488/data/products.dart';
import 'package:gonzalez0488/pages/product_details_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xffc5ddf6),
      appBar: AppBar(
        centerTitle: true,
        backgroundColor: const Color(0xffc5ddf6),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image.asset("assets/carne1.jpg"),
                            ),
                            Flexible(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
